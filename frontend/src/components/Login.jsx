...
const Login = ({ setToken }) => {
    ...
    const navigate = useNavigate();  // ✅ Use navigate inside a Router
    ...
    return (
        ...
        <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md border border-gray-300">
            ...
            <button onClick={() => navigate('/register')} className="text-center text-gray-600 mt-4" >Don't have an account ? Create Account</button>
        </div>
    </div>
    );
};
